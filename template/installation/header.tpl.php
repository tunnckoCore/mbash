...
.mb_banner {
	background: url('http://prikachi.com/images/348/5368348M.png') center center no-repeat;
	width: 468px;
	height: 60px;
	margin-left: auto;
	margin-right: auto;
...
<body onload="createGridder()">
	...
	<section id="wrapper" class="mb_20">
		<header class="header width_956 auto textcenter pt_5 pb_5">
			<a href="<?# LOGOLINK ?>" title="MartonBash CMS"><div class="mb_banner"></div></a>
		</header>
