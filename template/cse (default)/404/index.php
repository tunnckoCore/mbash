...
?>
		<div class="grid_4 mb_10 radius_5_all">
			...
			<h1 class="pl_20 textleft">Грешка 404..</h1>
			</div>
			<div class="grid_bottom pall_20">
			<p><b>Страницата, която търсите не може да бъде намерена или не съществува.</b></p>
			<div class="pt_10 pl_20">
<img src="<?php echo $this->dataInfo['404_DIR']; ?>" alt="Page Not Found"/>
			</div>
			</div>
		</div>